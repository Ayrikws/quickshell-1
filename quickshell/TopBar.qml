...
Item {
    ...
    IpcHandler {
        ...
        function queueReload() { Quickshell.reload(true) }
        function toggleUpdate() { /* toggle state globally */ }
    }
    ...
    Variants {
        ...
        delegate: Component {
            PanelWindow {
                ...
                Timer { interval: 0; running: true; onTriggered: barWindow.isStartupReady = true }
